...
import os
import json
from qgis.PyQt.QtWidgets import (QWidget, QVBoxLayout, QLabel, QLineEdit, QFormLayout,
     QGroupBox, QDockWidget, QScrollArea, QComboBox, QPushButton, QMessageBox, QToolButton, QFrame)
...
class CalculatorsDock(QDockWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.setFloating(True)  # Faz com que a dock seja uma janela flutuante
        self.setAllowedAreas(Qt.NoDockWidgetArea)  # Impede o encaixe novamente
